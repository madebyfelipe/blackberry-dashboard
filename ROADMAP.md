...
- ✅ **Testes automatizados** (`tests/`, runner do próprio Node, 335 casos das funções puras, incluindo o isolamento entre agências e a régua de clientes) **+ CI** (`.github/workflows/ci.yml`: tipos, testes e build a cada push e pull request)
