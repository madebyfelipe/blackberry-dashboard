...
4. **Ligar tarefa e lote ao `Client.id`** — hoje os três guardam o cliente de formas diferentes (texto livre na tarefa e no lote, entidade em `/clientes`). É o que destrava Health Score, timeline da conta e o filtro por cliente de verdade.
