...
Documento vivo. Marca o que já existe, o que falta **desenhar** (você) e o que falta **construir** (Claude), até o fim do projeto. Última atualização: **22 set 2026** (Blob privado, issue #39 — código pronto, falta o store novo na Vercel).
...
5. **Calendário editorial** lendo a data de publicação que o editor já grava, e a carga do time a partir do responsável.
6. **Envio automático do link** (WhatsApp/e-mail pelo servidor) + lembretes — depende da decisão de provedor (issue #13) e da ficha do cliente (#3, 🎨) para ter contato de verdade.
7. Continuar o CRM/Health Score (Fase 3) sobre a entidade de cliente que acabou de nascer.
